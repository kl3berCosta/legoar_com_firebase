...
public final class ProjectDao_Impl implements ProjectDao {
  ...
  public ProjectDao_Impl(@NonNull final RoomDatabase __db) {
    ...
    this.__insertionAdapterOfProjectEntity = new EntityInsertionAdapter<ProjectEntity>(__db) {
      ...
      protected String createQuery() {
        return "INSERT OR REPLACE INTO `projects` (`id`,`name`,`createdAt`,`updatedAt`,`thumbnailPath`) VALUES (?,?,?,?,?)";
      }
    ...
    this.__updateAdapterOfProjectEntity = new EntityDeletionOrUpdateAdapter<ProjectEntity>(__db) {
      ...
      @NonNull
      protected String createQuery() {
        return "UPDATE OR ABORT `projects` SET `id` = ?,`name` = ?,`createdAt` = ?,`updatedAt` = ?,`thumbnailPath` = ? WHERE `id` = ?";
      }
  ...
  @Override
  public Flow<List<ProjectEntity>> observeAllProjects() {
      ...
      public List<ProjectEntity> call() throws Exception {
        ...
        try {
          ...
          while (_cursor.moveToNext()) {
            ...
            _item = new ProjectEntity(_tmpId,_tmpName,_tmpCreatedAt,_tmpUpdatedAt,_tmpThumbnailPath);
            _result.add(_item);
          }
          return _result;
        } finally {
      ...
      public ProjectEntity call() throws Exception {
        ...
        try {
          ...
          if (_cursor.moveToFirst()) {
            ...
            _result = new ProjectEntity(_tmpId,_tmpName,_tmpCreatedAt,_tmpUpdatedAt,_tmpThumbnailPath);
          } else {
            _result = null;
          }
          return _result;
